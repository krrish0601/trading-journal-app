...
export default function TradeEditScreen() {
  ...
  const [tradeType, setTradeType] = useState<"long" | "short">(
    ...
    >
      <ScreenContainer className="p-4">
        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          {/* Tags */}
          <View className="mb-6">
            <Text className="text-xs text-muted mb-1">Tags (comma-separated)</Text>
            <TextInput
          ...
          <TouchableOpacity
            ...
            className="bg-primary py-4 rounded-lg items-center mb-8"
          >
